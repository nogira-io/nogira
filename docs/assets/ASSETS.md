# README / release screenshot assets

| File | Used in |
|------|---------|
| `nogira-banner.gif` | Root README banner |
| `nogira-home.gif` | README — Search & Workspace Management |
| `nogira-activity.gif` | README — Activities |
| `nogira-board-kanban.gif` | README — Kanban |
| `nogira-board-scrum.gif` | README — Scrum |
